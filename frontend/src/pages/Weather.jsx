...
// Add your API key here or use environment variables (recommended)
const API_KEY = process.env.REACT_APP_OPENWEATHER_API_KEY || "9e2cd413cc0491b115c175b7667aa687"; 
// Instructions: 
// 1. Get an API key from https://openweathermap.org/api
// 2. Add it to your .env file as REACT_APP_OPENWEATHER_API_KEY or replace the string above
